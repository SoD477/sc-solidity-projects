...
contract Raffle is VRFConsumerBaseV2Plus {
    ...
    /**
     * @dev This is the function that the Chainlink nodes will call to see if the raffle is ready to have a winner picked.
     * @param - ignored
     * @return upkeepNeeded - true iff it's time to restart raffle
     * @return - ignored
     */
