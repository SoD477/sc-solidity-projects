...
contract ClaimAirdrop is Script {
    ...
    // cast call <contract address> "getMessage(address,uint256)" 0xf39Fd6e51aad88F6F4ce6aB8827279cffFb92266 25000000000000000000 --rpc-url http:127.0.0.1:8545
    // cast wallet sign --no-hash <message> --private-key <PK> / --acount if not on anvil
    // the signature will change every time you redeploy the airdrop contract!
    bytes private SIGNATURE =
        hex"c4ecbbd7ce82644f121e21d01f59f51713a1506ab5c672601cbb32745954dc3924732b5527722f74b038a5e918ddcd89d1c33320a514bddea36299a373dd38d51c";
